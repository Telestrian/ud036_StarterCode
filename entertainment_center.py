...
the_lion_king = media.Movie(title="The Lion King",
                            poster="http://vignette3.wikia.nocookie.net/disney"
                                   "/images/c/cb/The_Lion_King_Textless_poster"
                                   "_1.jpg/revision/latest?cb=20140810104158",
                            trailer="https://www.youtube.com"
                                    "/watch?v=4sj1MT05lAA")

# put the movies into a list that can be passed to the fresh_tomatoes module

movies = [guardians_of_the_galaxy, star_wars, zootopia, arrival,
          the_lion_king, lord_of_the_rings]
